 ...
 * @author tgame14
 */
public abstract class TileMultiblockNode extends TileEntity
{
     ...
     */
    public abstract GridController getMultiblockController ();
     ...
     */
    public abstract WorldPos getWorldLocation ();
     ...
     */
    public abstract void onDetached (GridController multiblockController);
     ...
     * @see #onDetached(com.tgame.mods.libs.multiblocks.grid.GridController)
     ...
     */
    public abstract void onOrphaned (GridController oldController, int oldControllerSize, int newControllerSize);
     ...
     */
    public abstract Class<? extends GridController> getMultiblockControllerType ();
     ...
     */
    public abstract void onAssimilated (GridController newController);
     ...
     */
    public abstract TileMultiblockNode[] getNeighboringParts ();
     ...
     */
    public abstract void onMachineAssembled (GridController multiblockControllerBase);
     ...
     */
    public abstract Set<GridController> attachToNeighbors ();

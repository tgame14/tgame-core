 ...
 * @since 23/05/14
 */
public abstract class TileSimpleNode extends TileMultiblockNode
{
	...
	public void recalculateOutwardsDirection(WorldPos minCoord, WorldPos maxCoord)
	{
		...
		if (facesMatching <= 0)
		{
			facing = MultiblockFacing.INTERIOR;
		}
		else if (facesMatching >= 3)
		{
			facing = MultiblockFacing.FRAMECORNER;
		}
		else if (facesMatching == 2)
		{
			facing = MultiblockFacing.FRAME;
		}
		else
		{
			// 1 face matches
